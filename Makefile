MAIN = main
NAME = swjtuthesis
CLSFILES = $(NAME).cls swjtuextra.sty
BSTFILES = swjtunumerical.bst swjtuauthoryear.bst swjtubachelor.bst
...
zip : main doc
	...
	$(NAME).cls,$(NAME).pdf,figures,swjtunumerical.bst,swjtuauthoryear.bst,\
	swjtubachelor.bst,swjtuextra.sty,$(MAIN).tex,$(MAIN).pdf,chapters,bib,\
	.latexmkrc,Makefile}
	rm $(NAME)